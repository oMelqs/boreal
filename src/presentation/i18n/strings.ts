export const strings = {
  ...
  preferences: {
    ...
    numeric: {
      from: 'De',
      to: 'Até',
      decrease: (field: string) => `Diminuir ${field}`,
      increase: (field: string) => `Aumentar ${field}`,
      /** Anunciado e exibido quando o valor digitado sai dos limites. */
      clamped: (value: string) => `Ajustamos para o limite de ${value}.`,
      tempMinLabel: 'Temperatura mínima agradável, em graus Celsius',
      tempMaxLabel: 'Temperatura máxima agradável, em graus Celsius',
      tempMinField: 'temperatura mínima',
      tempMaxField: 'temperatura máxima',
      humidityField: 'limite de umidade',
      windField: 'limite de vento',
    },
